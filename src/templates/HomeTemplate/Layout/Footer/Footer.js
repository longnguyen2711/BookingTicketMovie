...
export default function Footer() {
  return (
    <footer className="py-6 dark:bg-coolGray-800 dark:text-coolGray-5 bg-gray-100">
      <div className="container px-6 mx-auto space-y-6 divide-y divide-coolGray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          ...
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            ...
            <ul>
              <li><a href="#" className="hover:dark:text-violet-400">Link</a></li>
              <li><a href="#" className="hover:dark:text-violet-400">Link</a></li>
              <li><a href="#" className="hover:dark:text-violet-400">Link</a></li>
              <li><a href="#" className="hover:dark:text-violet-400">Link</a></li>
              <li><a href="#" className="hover:dark:text-violet-400">Link</a></li>
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          ...
          <div className="flex justify-center pt-4 space-x-4 lg:pt-0 lg:col-end-13">
            ...
            <a
              href="#" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full dark:bg-violet-400 dark:text-coolGray-900">
